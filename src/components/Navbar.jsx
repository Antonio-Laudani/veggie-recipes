...
import { useApp } from '../contexts/AppContext'; // Importa il Context

const MyNavbar = () => {
  const location = useLocation();
  const { darkMode, toggleDarkMode, fontLexend, toggleFont } = useApp(); // Dal Context
      ...
      <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        ...
        <div className="flex items-center space-x-2 md:order-2">
          ...
          <button
            ...
            aria-label={fontLexend ? "Switch to classic font" : "Switch to Lexend font"}
          >
          ...
          <button
            ref={toggleButtonRef}
            type="button"
            className="inline-flex items-center p-2 w-10 h-10 justify-center text-sm rounded-lg md:hidden text-black bg-light-background hover:bg-light-green focus:outline-none focus:ring-2 focus:ring-light-green dark:bg-dark-background dark:hover:bg-bright-green dark:focus:ring-bright-green transition-colors duration-200"
